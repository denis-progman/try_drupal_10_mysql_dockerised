...
abstract class InstallerTestBase extends BrowserTestBase {
  ...
  public function installDrupal() {
    ...
    $this->container
      ->setParameter('web.root', DRUPAL_ROOT);
  ...
  protected function setUp(): void {
    ...
    if ($this->isInstalled) {
      ...
      $class_loader = require $this->container->getParameter('web.root') . '/autoload.php';
      Settings::initialize($this->container->getParameter('web.root'), DrupalKernel::findSitePath($request), $class_loader);
      ...
      // Not using File API; a potential error must trigger a PHP warning.
      chmod($this->container->getParameter('web.root') . '/' . $this->siteDirectory, 0777);
