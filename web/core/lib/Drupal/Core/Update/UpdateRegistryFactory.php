...
class UpdateRegistryFactory implements ContainerAwareInterface {
  ...
  public function create() {
    ...
    return new UpdateRegistry($this->container->getParameter('web.root'), $this->container->getParameter('site.path'), $extensions, $this->container->get('keyvalue')->get('post_update'));
  }
